...
return (
    ...
    <div className='d-flex justify-content-end mt-4'>
      ...
      <path d="M1.5 1.5A.5.5 0 0 1 2 1h12a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.128.334L10 8.692V13.5a.5.5 0 0 1-.342.474l-3 1A.5.5 0 0 1 6 14.5V8.692L1.628 3.834A.5.5 0 0 1 1.5 3.5z"/>
       ...
       <button className='suspend-button1' > Suspended</button> 
       <div className='suspend-parent'>
       <div className='child-parent'>
         <button className='child1' id="child11">Temporary Suspend</button>
         <button className='child2'>Suspend</button>
         <button className='child3'>Deleted</button>
 ...
 <tbody id="user-data">
 {
     tabledata.map((tdata,index)=>(
      ...
      <td id='suspend-data2'><img src="http://www.w3.org/2000/svg" className="rounded-circle" /> {tdata.username}</td>
       ...
       <div className='action-parent-table'>
        <button className="action-suspend dropdown-toggle" style={{color:"red"}}>Actions</button>
       <div className='retrive-parent'>
        <button className='retrive-child'>Retrive</button>
       </div>
       </div>       
       }
