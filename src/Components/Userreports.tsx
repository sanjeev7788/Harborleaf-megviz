...
<tbody >
  {
     tabledata.map((tdata)=>(
      ...
      <td>
        {
          tdata.id==5?(tdata.id==5&& (<div className='users-report-btns-parent'>
            <button className=" user-report-btns-child dropdown-toggle" >Actions</button>
              
              <div className='usermgmt-report-child-parent'>
                <button className='user-report-child'>Temporary Suspend</button>
                <button className='user-report-child'>Suspend </button>
                <button className='user-report-child'>Delete</button>
              </div>
             </div>   
           )):(<button className=" user-report-btns-child dropdown-toggle" >Actions</button>)  
