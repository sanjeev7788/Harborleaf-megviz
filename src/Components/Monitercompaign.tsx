...
import '../Styles/Monitercompaign.css';
...
<tbody >
  {
     tabledata.map((tdata,index)=>(
      ...
      <td>
       {
        tdata.id==2?(<div className='moniter-camp-butns-wrapper'>
          <button className="moniter-camp-butns" >Actions</button>
          <div className='monitercamp-child-parent'>
                   <button className='monitercamp-childs'>Edit</button>
                   <button className='monitercamp-childs'>Pause</button>
                   <button className='monitercamp-childs'>Delete</button>
                 </div>
               </div>       
          ):( <button className="moniter-camp-butns" >Actions</button>)
       }  
